...
var Onion = function(onionName) {
	...
	self.handle = function() {
		debug('Peeling the Onion', arguments[0]);

		// The exit function is always t-1
		var exitHandler = arguments[arguments.length - 1];

		var waterfallArgs = Array.prototype.slice.call(arguments);
		waterfallArgs.pop();
		waterfallArgs.unshift(null);

		// Wrap it with some info
		var exit = function() {
